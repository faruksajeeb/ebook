...
class CustomerPaymentReportController extends Controller
{
    ...
    public function index(Request $request){
        ...
        try { 
            ...
            $customer = null;
            $query = CustomerPayment::with(['customer','paymentmethod']);
            if (strpos($request->date_range, 'to')) {  
                ...
                $query->where('payment_date',$request->date_range);
            }
            ...
            if($request->btn_type=='excel'){
                ...
                $pdf = PDF::loadView('pdf-export.report.customer_payment.customer_payment_report_pdf', [
                    'customer' => $customer,
