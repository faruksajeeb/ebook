...
class SaleReportController extends Controller
{
    ...
    public function index(Request $request){
        ...
        try { 
            ...
            $customer = null;
            $query = Sale::with(['customer','paymentmethod'])->whereBetween('payment_date', [$startDate, $endDate]);
            ...
            if($request->btn_type=='excel'){
                ...
                return Excel::download(new SaleReportExport($customerPyments,$customer,"Customer Payment",$request->date_range), 'category.xlsx',\Maatwebsite\Excel\Excel::XLSX);
