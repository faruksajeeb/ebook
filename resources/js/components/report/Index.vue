<template>
  <div class="p-1 text-center my-3" >
    ...
    <h6 class="font-weight-bold" >
      Get the complete reporting of store.
    </h6>
  </div>
  <section class="section-menu" >
    <div class="col-md-12" >
      <div class="row" >
        ...
        <a
          href="#/store/income-statement-report"
          class="col-12 col-md-3 text-center hover-settings"
