<template>
  <div>
    <div class="row">
      <router-link to="/manage-expense" class="btn btn-primary">All Expense </router-link>
    </div>
...
export default {
  ...
  methods: {
    expenseUpdate() {
      let id = this.$route.params.id;
      axios
        .patch("/api/manage-expense/" + id, this.form)
        .then(() => {
          this.$router.push({ name: "manage-expense" });
