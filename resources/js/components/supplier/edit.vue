...
<template>
 ...
 <div class="row">
  <router-link to="/manage-supplier" class="btn btn-primary">All Supplier </router-link>
...
<script type="text/javascript">
  ...
  created(){
  	...
  	axios.get('/api/manage-supplier/'+id)
  ...
  supplierUpdate(){
  	  let id = this.$route.params.id
       axios.patch('/api/manage-supplier/'+id,this.form)
       .then(() => {
        this.$router.push({ name: 'manage-supplier'})
