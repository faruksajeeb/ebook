...
<template>
 ...
 <div class="row">
  <router-link to="/manage-employee" class="btn btn-primary">All Employee </router-link>
    ...
    <div class="row justify-content-center">
     ...
     <div class="col-md-6">
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Sallery" v-model="form.salary">
...
<script type="text/javascript">
  ...
  created(){
  	...
  	axios.get('/api/manage-employee/'+id)
  ...
  employeeUpdate(){
  	  let id = this.$route.params.id
       axios.patch('/api/manage-employee/'+id,this.form)
       .then(() => {
        this.$router.push({ name: 'manage-employee'})
